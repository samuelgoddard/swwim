        ...
        { isOpen ? (
          ...
          >
            ...
            <div className={`relative rounded-lg z-50 w-full h-full ${fullScreen ? '' : 'p-5 md:p-8 m-5 md:m-8 max-w-screen-2xl'}`}>
              <button className={`focus:outline-none absolute top-0 right-0 w-10 md:w-12 h-10 md:h-12 flex items-center justify-center z-50 rounded-full bg-blue ${ fullScreen ? 'mt-5 mr-5' : 'mt-8' }`} aria-label="close" onClick={close}>
