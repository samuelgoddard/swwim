...
export default function CaseTeaser({ heading, image, tags, index }) {
  return(
    <div className="flex flex-wrap text-current border-b border-current pt-6 pb-4 md:py-12 2xl:py-14 md:-mx-8">
          ...
          { image && (
            <>
              <div className="block md:hidden bg-blue">
                <Image width={image.width} height={image.height} layout="responsive" src={image.url} alt="Placeholder Dog" className="w-full" />
              </div>
