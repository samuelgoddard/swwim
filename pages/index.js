        ...
        <motion.div variants={fadeDelay} className="relative z-10">
          ...
          <Container>
            ...
            <div className="relative mb-8 md:mb-6 2xl:mb-8">
              ...
              <div className="overflow-hidden">
                <motion.span variants={textReveal} className="block font-display uppercase text-[13vw] md:text-[10.5vw] 2xl:text-[170px] leading-none relative z-10">Delivering</motion.span>
              </div>
              
              <div className="overflow-hidden">
                <motion.span variants={textReveal} className="block font-display uppercase text-[13vw] md:text-[10.5vw] 2xl:text-[170px] leading-none relative z-10">Creative</motion.span>
              </div>

              <div className="overflow-hidden">
                <motion.span variants={textReveal} className="block md:text-right font-display uppercase text-[13vw] md:text-[10.5vw] 2xl:text-[170px] leading-none relative z-10">Campaigns</motion.span>
              </div>
              
              <div className="overflow-hidden">
                <motion.span variants={textReveal} className="block md:text-right font-display uppercase text-[13vw] md:text-[10.5vw] 2xl:text-[170px] leading-none relative z-10">That Float</motion.span>
              </div>
